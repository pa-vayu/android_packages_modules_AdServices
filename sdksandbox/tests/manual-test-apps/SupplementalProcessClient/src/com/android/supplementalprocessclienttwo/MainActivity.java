...
package com.android.supplementalprocessclienttwo;
...
import com.android.supplemental.process.SupplementalProcessServiceImpl;

public class MainActivity extends Activity {

    private boolean mCodeLoaded = false;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSupplementalProcessManager = getApplicationContext().getSystemService(
    ...
    private class RemoteCodeCallbackImpl extends IRemoteCodeCallback.Stub {
        ...
        @Override
        public void onLoadCodeSuccess(IBinder token, Bundle bundle) {
            mCodeLoaded = true;
            mToken = token;
        ...
        @Override
        public void onLoadCodeFailure(int errorCode, String errorMessage) {
    ...
    private void registerLoadCodeProviderButton() {
        mLoadButton.setOnClickListener(v -> {
            ...
            params.putString(SupplementalProcessServiceImpl.CODE_PROVIDER_KEY,
                    "com.android.supplementalprocesscode.SampleCodeProvider");
            params.putInt(SupplementalProcessServiceImpl.WIDTH_KEY, mRenderedView.getWidth());
    ...
    private void registerLoadSurfacePackageButton() {
        mRenderButton.setOnClickListener(v -> {
            if (mCodeLoaded) {
                new Handler(Looper.getMainLooper()).post(
                        () -> mSupplementalProcessManager.requestSurfacePackage(
