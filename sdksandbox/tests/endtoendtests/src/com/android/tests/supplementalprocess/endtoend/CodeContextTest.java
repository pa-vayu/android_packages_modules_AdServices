...
public class CodeContextTest {
    ...
    public void setUp() throws Exception {
        ...
        mCodeContext = new CodeContext(InstrumentationRegistry.getContext(), info);
    }

    @Test
    public void testResources() {
        Resources resources = mCodeContext.getResources();
    ...
    public void testAssets() throws Exception {
        AssetManager assets = mCodeContext.getAssets();
