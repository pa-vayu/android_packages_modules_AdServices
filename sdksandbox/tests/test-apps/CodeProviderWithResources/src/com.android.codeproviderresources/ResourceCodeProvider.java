...
public class ResourceCodeProvider extends CodeProvider {
    ...
    public void initCode(CodeContext context, Bundle params,
        ...
        try (BufferedReader reader = new BufferedReader(
            ...
            callback.onInitCodeError("File not found: " + ASSET_FILE);
        }
        callback.onInitCodeFinished(new Bundle());
    }
    ...
    private void sendError(InitCodeCallback callback, String expected, String actual) {
        callback.onInitCodeError("Expected " + expected + ", actual " + actual);
    }
}
